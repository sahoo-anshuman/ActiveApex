...
export const fitnessTrainingData = [
  {
    ...
    description: "Pilates is a form of exercise that focuses on strengthening the core, improving flexibility, and enhancing overall body alignment and posture. ",
...

  {
    ...
    description: "Also known as cardiovascular or endurance training, focuses on improving the efficiency of the cardiovascular system and increasing stamina.",
...

  {
    ...
    description: "CrossFit is a high-intensity fitness training program that combines elements from various exercise disciplines including weightlifting, gymnastics, and cardiovascular training. ",
...
export const homeSwiperData = [
  {
    ...
    description: `Our athletics trainers are dedicated to optimizing your performance and enhancing your fitness journey. They craft specialized training programs tailored to your unique athletic goals, whether you're looking to boost strength, agility, or endurance.`,
  },

  {
    ...
    description: `With personalized dietary guidance to help individuals manage their health, improve well-being, and achieve their specific health goals, getting into a perfect shape is never this easy.`,
  },
...
export const gymAmenitiesData = [
...

  {
    ...
    description: "Strong wifi connection over the entire gym facility and restrooms for both males and females. ",
  },

  {
    id: 6,
    title: "Hot Showers & Hair Care",
    description: `Get facilities of showers, to make you feel rejuvenated after a long and tiring session.`,
  },
];
